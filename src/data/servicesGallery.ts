const servicesGallery = [
  {
    ...
    subtitle: 
    `We create clean, contemporary designs that elevate any environment, from intimate gatherings 
    to grand events.`,
  },
  {
    id: 1,
    ...
    subtitle: 
    `Our selection of locally sourced flora brings natural resilience and effortless 
  ...
  },
  {
    ...
    subtitle: 
    `Your vision, our blooms. We build arrangements that are both personal 
